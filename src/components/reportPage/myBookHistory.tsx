  ...
  return (
    <div>
      {data.map((item, index) => (
        <div
          key={index}
          className='bg-background-input flex w-full h-[240px] rounded-[20px] mb-7 p-10'
        >
          <section className='flex'>
            ...
            <div className='flex flex-col justify-end ml-4'>
              <p className='font-sans font-medium text-base mb-2 text-gray-900'>{item.title}</p>
              <p className='font-sans font-medium text-sm mb-2 text-gray-700'>{item.author}</p>
      ...
      <button className='w-full h-[50px] rounded-[8px] bg-background-input font-sans font-medium text-base text-gray-700 mb-[89px]'>
        더보기
      </button>
    </div>
  );
